  ...
  <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 via-white to-blue-100 flex flex-col">
    ...
    <nav className="flex justify-center items-center px-6 sm:px-10 py-5 bg-transparent">
      ...
      >
        ...
        <span className="font-bold text-[#0a1628] text-base tracking-wide">
          DocDirectory
        </span>
      </div>
    </nav>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-2">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Join DocDirectory and get started
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className={`w-full border px-4 py-3 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 transition
                ${error.name ? "border-red-300 bg-red-50/40" : "border-gray-200 bg-white"}`}
              />
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full border px-4 py-3 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 transition
                ${error.confirmPassword ? "border-red-300 bg-red-50/40" : "border-gray-200 bg-white"}`}
              />
              ...
              <>
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    ${error.verificationCode ? "border-red-300 bg-red-50/40" : "border-gray-200 bg-white"}`}
                  />
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full border px-4 py-3 rounded-xl text-sm
                    ${error.company_name ? "border-red-300 bg-red-50/40" : "border-gray-200 bg-white"}`}
                  />
